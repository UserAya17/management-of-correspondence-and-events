...
.j2{
    ...
    <ul class="nav-links">
    <li ><a href="view_courrier.php"><p class="j2">tous les courriers</p></a></li>
    <li ><a href="view_courrier_entrant.php"><p class="j2">entrant</p></a></li>
    <li ><a href="view_courrier_sortant.php"><p class="j" >sortant</p></a></li>
...
<td>
	...
	<table>
    <tr>	
  <td> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td>
         <td>	
            <a href="addfile2.php" >
   ...
   <div >
        ...
        <form method="post" action="delete.php" >
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped mt-3" id="example">
                            ...
                            <thead>
                                ...
                                <th ><i style="color:#AEF5F8;" class="fa-solid fa-arrow-down-a-z"></i><p class="cl">ID</p></th>
                                    ...
                                    <th><p class="cl">ENREPRISE DESTINATION</p></th>
                                    <th><p class="cl">DATE ET HEURE</p></th>

                                    <th><p class="cl">SOURCE</p></th>		
				...
				<!-- <th>ÉLIMINER</th> -->
                            ...
                            <tbody>
							<?php 
							$query=mysqli_query($conn,"select * from  cr_sortant  ORDER BY id DESC")or die(mysqli_error($conn));
							...
							?>
										...
										<tr class="cl3">
                                         ...
                                         <td>
				<a href="voir2.php?fileid=<?php echo $id;?>" title="click to voir"><i class="fa-solid fa-envelope-open-text"></i></a>
				</td>
				...
				<!-- <td>
				<a href="delete2.php?del=<?php// echo $row['id']?>"><i class="fa-solid fa-circle-minus"></i></a>
				</td> -->
                                </tr>
...
<form method="post" action="export_sortant.php">
