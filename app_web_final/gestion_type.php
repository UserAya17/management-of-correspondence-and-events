...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      $message[] = 'type_cour already exist'; 
   }else{
     
         $insert = mysqli_query($conn, "INSERT INTO `type_cour`(type_cour) VALUES('$type_cour')") or die('query failed');
         }
  ...
  <li class="item">
                    ...
                    <li class="item" id="messages">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="view_type.php"><i  class="fas fa-envelope-open-text"></i><span >Type </span><i class="fas fa-quote-right"></i></a>
                        </div>
                    </li>
                    <li class="item" id="profile">
...
<td>  
<div class="cont">
        <div class="text">Ajouter un type </div>
...
<form action="" method="post" enctype="multipart/form-data">
 ...
 <div class="form-row">
              <div class="input-data">
                 ...
                 <input type="text" name="type_cour"  required>
   ...
   <input type="submit" name="submit" value="Ajouter type" class="btn">
  <a href="view_type.php" > <button class="btn btn-success m-3" type="button" >
              voir la liste
            </button></a>
