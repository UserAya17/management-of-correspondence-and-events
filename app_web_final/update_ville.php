...
$old_ville = $_POST['old_ville'];


   
if(mysqli_num_rows($select) > 0 && $ville!= $old_ville ){
   $message[] = 'ville already exist'; 
}else{
  
    mysqli_query($conn, "UPDATE `ville` SET ville = '$ville' WHERE ville_id = '$ville_id'") or die('query failed');
 }
...
<td> 
        ...
        <div class="cont">
        <div class="text">Modifier ville</div>
...
<?php
      $select1 = mysqli_query($conn, "SELECT * FROM `ville` WHERE ville_id = '$ville_id'") or die('query failed');
...
<div class="form-row">
              <div class="input-data">
                 ...
                 <input type="text" name="ville" value="<?php echo $fetch1['ville']; ?>">
           ...
           <input type="hidden" name="old_ville" value="<?php echo $fetch1['ville']; ?>">

<br>
   <input type="submit" value="Mettre à jour" name="update_ville" class="btn">
   <a href="view_ville.php" class="delete-btn">Retourner</a>
</form>
</tr>
</table>
</div>
