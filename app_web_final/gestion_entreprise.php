...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      $message[] = 'entreprise already exist'; 
         ...
         $insert = mysqli_query($conn, "INSERT INTO `entreprise`(ent_name,ent_detail,image) VALUES('$ent_name','$ent_detail','$image')") or die('query failed');
         }
         if($insert){
  ...
  <li class="item">
                    ...
                    <li class="item" id="messages">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="view_entreprise.php"><i  class="fas fa-building"></i><span  ">Entreprise </span><i class="fas fa-quote-right"></i></a>
...
<td>  
<div class="cont">
        <div class="text">Ajouter un entreprise </div>
...
<form action="" method="post" enctype="multipart/form-data">
 ...
 <div class="form-row">
              <div class="input-data">
                 ...
                 <input type="text" name="ent_name"  required>
              ...
              <div class="input-data">
                 ...
                 <input type="text" name="ent_detail" required>
                 <div class="underline"></div>
           ...
           <div   class="input-data1">
             <input type="file" name="image" placeholder="logo" accept="image/jpg, image/jpeg, image/png">
                 <div class="underline"></div>

           </div></div>


   <input type="submit" name="submit" value="Ajouter entreprise" class="btn">
  <a href="view_entreprise.php" > <button class="btn btn-success m-3" type="button" >
              voir la liste
            </button></a>
