...
<?php 
  ...
  $ReadSql = "SELECT * FROM `entreprise` ";
    ...
    <table class="table table-striped mt-3">
      <thead>
        <tr class="cl2">
          ...
          <th><p class="cl">Nom d'entreprise</p></th>
        <th><p class="cl">detail</p></th>
        <th><p class="cl">logo</p></th>
      ...
      <tbody  class="cl3">
        ...
        <tr>
          <th scope="row"><?php echo $r['ent_id']; ?></th>
          <td><?php echo $r['ent_name']; ?></td>
          <td><?php echo $r['ent_detail']; ?></td>
          <td><?php

if(empty($r['image'])){
  echo '<img width="30px" src="images/logo.png">';
}else{
echo '<img width="30px" src="uploaded_img/'.$r['image'].'">'; 
}
?> </td>
...
?>
          <td>
            <a href="update_entreprise.php?id=<?php echo $r['ent_id']; ?>" class="m-2">
              <i class="fa fa-edit fa-2x"></i>
            </a>
           
            <i class="fa-solid fa-trash-can"
             data-bs-toggle="modal"
             data-bs-target="#exampleModal<?php echo $r['ent_id']; ?>">
              
             </i>

             <div class="modal fade" id="exampleModal<?php echo $r['ent_id']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-body">
                  <p>êtes-vous sûr de vouloir supprimer l'entreprise avec l'identifiant : <?php echo  $r['ent_id']; ?> ?</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                    data-bs-dismiss="modal">Annuler</button>
                    <a href="delete_entreprise.php?id=<?php echo $r['ent_id']; ?>">
