...
$ent_detail = mysqli_real_escape_string($conn, $_POST['ent_detail']);

$select = mysqli_query($conn, "SELECT * FROM `entreprise` WHERE   ent_name = '$ent_name' ") or die('query failed');

$old_ent = $_POST['old_ent'];


   
if(mysqli_num_rows($select) > 0 && $ent_name!= $old_ent ){
   $message[] = 'entreprise already exist'; 
}else{
  
    mysqli_query($conn, "UPDATE `entreprise` SET ent_name = '$ent_name', ent_detail = '$ent_detail' WHERE ent_id = '$ent_id'") or die('query failed');
 }
 ...
 if(!empty($update_image)){
    if($update_image_size > 2000000){
       ...
       $image_update_query = mysqli_query($conn, "UPDATE `entreprise` SET image = '$update_image' WHERE ent_id = '$ent_id'") or die('query failed');
...
<td> 
        ...
        <div class="cont">
        <div class="text">Modifier entreprise</div>
...
<?php
      $select1 = mysqli_query($conn, "SELECT * FROM `entreprise` WHERE ent_id = '$ent_id'") or die('query failed');
...
<div class="form-row">
              <div class="input-data">
                 ...
                 <input type="text" name="ent_name" value="<?php echo $fetch1['ent_name']; ?>">
                 <div class="underline"></div>
                 <label for="">entreprise :</label>
              </div>
              <div class="input-data">
              <input type="text" name="ent_detail" value="<?php echo $fetch1['ent_detail']; ?>">
                 <div class="underline"></div>
           ...
           <input type="hidden" name="old_ent" value="<?php echo $fetch1['ent_name']; ?>">

<br>
   <input type="submit" value="Mettre à jour" name="update_entreprise" class="btn">
   <a href="view_entreprise.php" class="delete-btn">Retourner</a>
</form>
</tr>
</table>
</div>
