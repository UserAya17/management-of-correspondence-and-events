  ...
  <li class="item">
                    ...
                    <li class="item" id="messages">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="view_direction.php"><i  class="fas fa-computer"></i><span >Source </span><i class="fas fa-quote-right"></i></a>
...
<center>
<a href="gestion_direction.php">
  <button class="btn1" type="">
    Ajouter un direction
  </button>
</a>
    </center>
</div>  
    ...
    <table class="table table-striped mt-3">
      <thead class="cl2">
        <tr >
          ...
          <th><p class="cl">Nom direction</p></th>
      ...
      <tbody class="cl3">
        ...
        <tr  >
          <th scope="row"><?php echo '<p class="cl4">'. $r['direc_id'].'</p>'; ?></th>
          <td><?php echo $r['direc_name']; ?></td>
...
<?php
$_SESSION['direc_id']= $r['direc_id'];
?>
          <td>
            <a href="update_direction.php?id=<?php echo $r['direc_id']; ?>" class="m-2">
              <i class="fa fa-edit fa-2x"></i>
            </a>
           
            <i class="fa-solid fa-trash-can"
             data-bs-toggle="modal"
             data-bs-target="#exampleModal<?php echo $r['direc_id']; ?>">
              
             </i>

             <div class="modal fade" id="exampleModal<?php echo $r['direc_id']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-body">
                  <p>êtes-vous sûr de vouloir supprimer la direction avec l'identifiant : <?php echo $r['direc_id']; ?> ?</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                    data-bs-dismiss="modal">Annuler</button>
                    <a href="delete_direction.php?id=<?php echo $r['direc_id']; ?>">
