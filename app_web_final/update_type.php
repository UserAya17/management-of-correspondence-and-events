...
$type_cour = mysqli_real_escape_string($conn, $_POST['type_cour']);


$select = mysqli_query($conn, "SELECT * FROM `type_cour` WHERE  type_cour = '$type_cour' ") or die('query failed');

$old_type = $_POST['old_type'];


   
if(mysqli_num_rows($select) > 0 && $type_cour!= $old_type ){
   $message[] = 'type already exist'; 
}else{
  
    mysqli_query($conn, "UPDATE `type_cour` SET type_cour = '$type_cour' WHERE type_id = '$type_id'") or die('query failed');
 }
...
<td> 
        ...
        <div class="cont">
        <div class="text">Modifier type</div>
...
<?php
      $select1 = mysqli_query($conn, "SELECT * FROM `type_cour` WHERE type_id = '$type_id'") or die('query failed');
...
<div class="form-row">
              <div class="input-data">
                 ...
                 <input type="text" name="type_cour" value="<?php echo $fetch1['type_cour']; ?>">
           ...
           <input type="hidden" name="old_type" value="<?php echo $fetch1['type_cour']; ?>">

<br>
   <input type="submit" value="Mettre à jour" name="update_type" class="btn">
   <a href="view_type.php" class="delete-btn">Retourner</a>
</form>
</tr>
</table>
</div>
