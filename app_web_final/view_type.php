  ...
  <br>
    ...
    <table class="table table-striped mt-3">
      ...
      <tbody class="cl3">
        ...
        <tr>
          <th scope="row"><?php echo $r['type_id']; ?></th>
          <td><?php echo $r['type_cour']; ?></td>
...
<?php
$_SESSION['type_id']= $r['type_id'];
?>
          <td>
            <a href="update_type.php?id=<?php echo $r['type_id']; ?>" class="m-2">
              <i class="fa fa-edit fa-2x"></i>
            </a>
           
            <i class="fa-solid fa-trash-can"
             data-bs-toggle="modal"
             data-bs-target="#exampleModal<?php echo $r['type_id']; ?>">
              
             </i>

             <div class="modal fade" id="exampleModal<?php echo $r['type_id']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-body">
                  <p>êtes-vous sûr de vouloir supprimer le type avec l'identifiant :<?php  echo $r['type_id']; ?> ?</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                    data-bs-dismiss="modal">Annuler</button>
                    <a href="delete_type.php?id=<?php echo $r['type_id']; ?>">
