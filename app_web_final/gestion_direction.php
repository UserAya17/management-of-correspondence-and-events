...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      $message[] = 'direction already exist'; 
         ...
         $insert = mysqli_query($conn, "INSERT INTO `direction`(direc_name,detail) VALUES('$direc_name','$detail')") or die('query failed');
         }
...
<td>  
<div class="cont">
        <div class="text">Ajouter un direction </div>
...
<form action="" method="post" enctype="multipart/form-data">
 ...
 <div class="form-row">
              <div class="input-data">
                 ...
                 <input type="text" name="direc_name"  required>
   ...
   <input type="submit" name="submit" value="Ajouter direction" class="btn">
  <a href="view_direction.php" > <button class="btn btn-success m-3" type="button" >
              voir la liste
            </button></a>
