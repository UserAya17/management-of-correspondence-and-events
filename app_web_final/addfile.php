...
if(isset($_POST['submit'])!=""){
  ...
  $sql = "INSERT INTO cr_entrant (name,entreprise,date,ville_ent,objet_ent,dest_direc,comment,numero,nbr_cour,type_ent) VALUES ('$name','$entreprise','$date','$ville','$objet_ent','$direction','$comment','$numero','$nbr_cour','$type_ent')";
  
  if ($conn->query($sql) === TRUE) {
      $last_id = $conn->insert_id;
      header("location:view_courrier_entrant.php");
  } 

  


// $query=$conn->query("INSERT INTO cr_entrant (name,entreprise,date,ville_ent,objet_ent,dest_direc,comment,numero,nbr_cour,type_ent) VALUES ('$name','$entreprise','$date','$ville','$objet_ent','$direction','$comment','$numero','$nbr_cour','$type_ent')");
...
if(isset($_POST['submit'])!=""){
 ...
 $select44 = mysqli_query($connect, "SELECT * FROM `direction` WHERE  direc_name = '$direction' ") or die('query failed');
 $row44 = mysqli_fetch_assoc($select44);
$f= $row44['direc_id'];




 $query55=mysqli_query($connect,"select * from  user_form where direction = '$f'  ")or die(mysqli_error($connect));
 while($row55=mysqli_fetch_array($query55)){
 $id=$row55['id'];


 $query77 = "
 INSERT INTO comments(comment_subject, comment_text,user_id,direc_id,cr_id)
 VALUES ('$objet_ent', '$entreprise','$id','$f','$last_id')
 ";
...
$query77 = "
INSERT INTO comments(comment_subject, comment_text,user_id,direc_id,cr_id)
VALUES ('$objet_ent', '$entreprise','$id','0','$last_id')
";
mysqli_query($connect, $query77);
}
...
<table>
  ...
  <td>  
<div class="cont">
        <div class="text">Ajouter courrier entrant </div>
...
<form action="" method="post" enctype="multipart/form-data">
 ...
 <div   class="input-data1"><input type="file" name="photo" id="photo"  required="required">
              ...
              <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</span><label for=""> ville source: </label>
...
?>
              ...
              <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</span>
              <label for=""> entreprise messagerie</label>
              <div   class="input-data1">
                 <table>
...
<td>
  <table><td><label for="">destination: </label></td>
  <td>&nbsp &nbsp</td>
  <td>
...
<script src="js/count.js"></script>
  ...
  <a href="view_courrier_entrant.php" > <button class="btn btn-success m-3" type="button" >
              voir la liste
            </button></a>
