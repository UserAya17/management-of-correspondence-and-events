...
.j2{
    ...
    <ul class="nav-links">
    <li class="center"><a href="consulter_admin.php"><p class="j2">entrant</p></a></li>
    <li class="center"><a href="consulter_admin_sortant.php"><p class="j" >sortant</p></a></li>
...
<td>
   ...
   <div >
        ...
        <td>
        <?php 
     $select3333 = mysqli_query($conn, "SELECT * FROM `comments` WHERE  user_id = '$user_id' AND cr_id = '$id' and comment_status=0 and type_cr='sort'") or die('query failed');
